...
const FAQS = [
  ...
  {q:'How long does my certification last?', a:'Most CISRS OTS certifications are valid for five years. We recommend booking your refresher before expiry — and any Radian certificate can be checked on our Verify a Certificate page.'},
